...
| **Virtualization** | Kali Linux (VM) |
| **Hardware Tools** | M5StickC Plus 2 |
...
All content, scripts, and techniques documented in this repository are intended solely for educational purposes and ethical testing on systems where I have explicit permission.

I am **not responsible** for any misuse of the information provided here. Do not use these tools to attack targets without authorization.

*so if u hack evil corp with that im not responible*
---
*Created by patvex(yes i formated this with LLM)*
